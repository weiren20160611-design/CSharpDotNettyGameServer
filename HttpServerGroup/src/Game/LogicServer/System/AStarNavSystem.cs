...
namespace Game.LogicServer
{
    ...
    {
        public static void StartRoadNavAction(GM_PlayerEntity player, List<RoadNode> roadNodes)
        {
        ...
        public static void StopNavAction(AOIMgr aoi, GM_PlayerEntity e)
        {
        ...
        private static void WalkToNext(GM_PlayerEntity e)
        {
            ref AStarComponent nav = ref e.uAStar;
        ...
        public static void NavRoadUpdate(GM_PlayerEntity e, AOIMgr aoi, float dt)
        {
            ref AStarComponent nav = ref e.uAStar;
