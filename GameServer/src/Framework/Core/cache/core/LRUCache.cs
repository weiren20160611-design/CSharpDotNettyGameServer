...
namespace Framework.Core.Cache
{
    ...
    public class LRUCache<K, V>
    {
        ...
        public LRUCache(CacheBuilder<K, V> cacheBuilder)
        {
            ...
            this.cache = new System.Runtime.Caching.MemoryCache(Guid.NewGuid().ToString());
        ...
        public Tuple<V, DateTime, DateTime> Get(K key)
        {
            ...
            try
            {
                ...
                if (!pass)
                {
                    return new Tuple<V, DateTime, DateTime>(default, readTime, writeTime);
                }
