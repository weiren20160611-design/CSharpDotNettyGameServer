...
namespace Game
{
    ...
    {
        public static ResSyncCharactorStatus GetResSyncCharactorStatus(BaseEntity player)
        {
        ...
        public static void SyncEntityStatus(BaseEntity player, AOIMgr aoi, int status)
        {
