...
namespace Game.LogicServer
{
    ...
    public class AStarMapWrapper : IMapWrapper
    {
        ...
        private PathFindingAgent pathFindingAgent = null;
        ...
        public void LoadMapData(int mapId)
        {
            ...
            pathFindingAgent = new PathFindingAgent();
            pathFindingAgent.init(this.mapData);
        }
        ...
        {
            List<RoadNode> roadNodes = this.pathFindingAgent.seekPath2(player.uTransform.pos.x, player.uTransform.pos.z, x, z);
