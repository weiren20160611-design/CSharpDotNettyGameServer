    ...
    public class Simulator
    {
        ...
        private class Worker
        {
            ...
            internal void step(object obj)
            {
                ...
                {
                    this.simulator.agents_[index].computeNeighbors();
                    this.simulator.agents_[index].computeNewVelocity();
                }
                doneEvent_.Set();
            }
        ...
        //停止位移
        public void standby(int agentNo)
        {
            agents_[agentNo2indexDict_[agentNo]].standby = true;
        }

        //启动位移
        public void wakeup(int agentNo)
        {
            agents_[agentNo2indexDict_[agentNo]].standby = false;
        }
    }
}
