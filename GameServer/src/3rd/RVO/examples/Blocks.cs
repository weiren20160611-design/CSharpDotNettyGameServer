...
namespace RVO
{
    class Blocks
    {
        ...
        public Blocks(Simulator simulator)
        {
        ...
        void setupScenario()
        {
             ...
             * added.
             */
            this.simulator.setAgentDefaults(15.0f, 10, 5.0f, 5.0f, 2.0f, 2.0f, new Vector2(0.0f, 0.0f));
            ...
            for (int i = 0; i < 5; ++i)
            {
                for (int j = 0; j < 5; ++j)
                {
                    this.simulator.addAgent(new Vector2(55.0f + i * 10.0f, 55.0f + j * 10.0f));
        ...
        void setPreferredVelocities()
        {
            ...
            for (int i = 0; i < this.simulator.getNumAgents(); ++i)
            {
                ...
                this.simulator.setAgentPrefVelocity(i, this.simulator.getAgentPrefVelocity(i) +
        ...
        bool reachedGoal()
        {
            ...
            for (int i = 0; i < this.simulator.getNumAgents(); ++i)
            {
                if (RVOMath.absSq(this.simulator.getAgentPosition(i) - goals[i]) > 400.0f)
                {
                    return false;
                }
            }
        ...
        public static void Main(string[] args)
        {
            ...
            Blocks blocks = new Blocks(simulator);
